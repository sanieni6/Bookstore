...
"BookStore" is a web project maden with the React framework. This page display a list of books, Add a book and Remove a selected book. 
By building this application, I implement all that I learned in Microverse about React and Redux in the context of a real application.
...
- git clone git@github.com:sanieni6/Bookstore.git
- cd Leaderboard
